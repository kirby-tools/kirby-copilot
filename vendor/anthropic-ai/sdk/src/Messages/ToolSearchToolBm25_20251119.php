...
use Anthropic\Messages\ToolSearchToolBm25_20251119\AllowedCaller;
use Anthropic\Messages\ToolSearchToolBm25_20251119\Type;

/**
 * @phpstan-import-type CacheControlEphemeralShape from \Anthropic\Messages\CacheControlEphemeral
 *
 * @phpstan-type ToolSearchToolBm25_20251119Shape = array{
 ...
 * }
 */
final class ToolSearchToolBm25_20251119 implements BaseModel
{
    /** @use SdkModel<ToolSearchToolBm25_20251119Shape> */
    use SdkModel;
    ...
    /**
     * `new ToolSearchToolBm25_20251119()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ToolSearchToolBm25_20251119::with(type: ...)
     * ```
     *
     ...
     * This is how the tool will be called by the model and in `tool_use` blocks.
     *
     * @param 'tool_search_tool_bm25' $name
     */
