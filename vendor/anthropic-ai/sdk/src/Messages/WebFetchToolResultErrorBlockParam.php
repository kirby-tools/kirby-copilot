...
/**
 * @phpstan-type WebFetchToolResultErrorBlockParamShape = array{
 *   errorCode: WebFetchToolResultErrorCode|value-of<WebFetchToolResultErrorCode>,
 *   type: 'web_fetch_tool_result_error',
 * }
 */
final class WebFetchToolResultErrorBlockParam implements BaseModel
{
    /** @use SdkModel<WebFetchToolResultErrorBlockParamShape> */
    use SdkModel;
    ...
    /**
     * `new WebFetchToolResultErrorBlockParam()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WebFetchToolResultErrorBlockParam::with(errorCode: ...)
     * ```
     *
