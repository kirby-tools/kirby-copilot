...
use Anthropic\Beta\Messages\BetaAdvisorToolResultError\ErrorCode;
 ...
 * }
 */
final class BetaAdvisorToolResultError implements BaseModel
{
    /** @use SdkModel<BetaAdvisorToolResultErrorShape> */
    use SdkModel;
    ...
    /**
     * `new BetaAdvisorToolResultError()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BetaAdvisorToolResultError::with(errorCode: ...)
     * ```
     *
