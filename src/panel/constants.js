...
- If response_format is set to "text", Format your response using Markdown syntax. Do not use backticks or any other wrapping characters around your Markdown.
`;
